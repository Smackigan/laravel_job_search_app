        ...
        <form method="POST" action="/listings/{{ $listing->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" value="{{ $listing->title }}"
                    name="title" placeholder="Example: Junior Laravel Developer" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" value="{{ $listing->location }}"
                    name="location" placeholder="Example: Remote, Tallinn, etc" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" value="{{ $listing->tags }}"
                    name="tags" placeholder="Example: Laravel, Backend, MySQL, etc" />
